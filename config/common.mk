...
# ArsenalsOS: do not create addon.d (avoid 3rd-party ROM detection)
# PRODUCT_PACKAGES += \
#     50-lineage.sh
...
# ArsenalsOS: AOS system service (arsenalsos boot jar)
include vendor/arsenals/arsenalsos/config/common.mk
